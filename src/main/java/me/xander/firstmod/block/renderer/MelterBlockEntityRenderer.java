...
import me.xander.firstmod.block.entity.custom.TankBlockEntity;
...
public class MelterBlockEntityRenderer implements BlockEntityRenderer<MelterBlockEntity> {
    ...
    public MelterBlockEntityRenderer(BlockEntityRendererFactory.Context context) {

    }

    @Override
    public void render(MelterBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
