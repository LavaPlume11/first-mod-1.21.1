...
public class ModItems {
    ...
    public static final Item MITHRIL_SWORD_SHARD = registerItem("mithril_sword_shard", new SwordShard(new Item.Settings().maxCount(8)));
    public static final Item MITHRIL_HELMET = registerItem("mithril_helmet", new ArmorItem(ModArmorMaterials.MITHRIL_ARMOR,
            ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(ModArmorMaterials.MITHRIL_DURABILITY_MULTIPLIER))));
    public static final Item MITHRIL_CHESTPLATE = registerItem("mithril_chestplate",  new  ArmorItem(ModArmorMaterials.MITHRIL_ARMOR,
            ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(ModArmorMaterials.MITHRIL_DURABILITY_MULTIPLIER))));
    public static final Item MITHRIL_LEGGINGS = registerItem("mithril_leggings",  new ModArmorItem(ModArmorMaterials.MITHRIL_ARMOR,
            ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(ModArmorMaterials.MITHRIL_DURABILITY_MULTIPLIER))));
    public static final Item MITHRIL_BOOTS = registerItem("mithril_boots",  new  ArmorItem(ModArmorMaterials.MITHRIL_ARMOR,
            ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(ModArmorMaterials.MITHRIL_DURABILITY_MULTIPLIER))));
    ...
    public static final Item NETHER_BOW = registerItem("nether_bow",  new BowItem(new Item.Settings().maxDamage(500)));
